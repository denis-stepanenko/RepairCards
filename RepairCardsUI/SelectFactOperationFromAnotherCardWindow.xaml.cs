...
{
    public partial class SelectFactOperationFromAnotherCardWindow : Window
    {
        ...
        public SelectFactOperationFromAnotherCardWindow(int cardId)
        {
            InitializeComponent();
            _cardId = cardId;
        }
        ...
        void Refresh()
        {
            var items = _cardOperationRepo.GetAllByCardAndType(_card.Id, 1);
