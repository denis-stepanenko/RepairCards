...
{
    public partial class SelectOperationFromPlanWindow : Window
    {
        ...
        public SelectOperationFromPlanWindow(int cardId)
        {
            InitializeComponent();
            _cardId = cardId;
            Refresh();
        ...
        void Refresh()
        {
            IEnumerable<CardOperation> operations;

            if (new[] { 4, 5, 6, 13, 17, 80, 82 }.Contains(AuthorizationService.User.Department))
                operations = _cardOperationRepo.GetAllByDepartment(_cardId, 0, AuthorizationService.User.Department);
            else
                operations = _cardOperationRepo.GetAllByCardAndType(_cardId, 0);
        ...
        private void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (var operation in operations)
            {
                var newCardOperation = new CardOperation
                {
                    ...
                    TemplateCode = operation.TemplateCode,
